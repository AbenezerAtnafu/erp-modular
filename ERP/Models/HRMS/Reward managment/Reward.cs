...
namespace ERP.Models.HRMS.Reward_managment
{
    public class Reward
    {
        ...
        [StringLength(200, ErrorMessage = "Description field must be between {5} and {200} characters long.")]
        public string? description { get; set; }
        
        [StringLength(200, ErrorMessage = "Reason of reward field must be between {5} and {200} characters long.")]
