...
{
    public static IApplicationBuilder UseMvcModulesStaticFiles(this IApplicationBuilder app, ILoggerFactory loggerFactory, IConfigurationRoot configuration, string staticCommonPrefix = null)
    {
        if (app == null)
        {
        ...
        {
            module.InitConfigs(app, loggerFactory, configuration);
